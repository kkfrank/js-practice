...
<div class="loading-data" style="display: none;z-index:9999;">
    <img src="${ctx}/static/fm/common/images/loading.gif">
        ...
        <div class="hour-split">
        <div class="hour-line"></div>
        <div class="hour-scale scale-1x">
        <i class="lf"></i>
        <i class="rf"></i>
        <span>1X</span>
        </div>
        <div class="hour-scale scale-2x">
        <i class="lf"></i>
        <i class="rf"></i>
        <span>2X</span>
        </div>
        <div class="hour-scale scale-3x">
        <i class="lf"></i>
        <i class="rf"></i>
        <span>3X</span>
        </div>
        <div class="hour-scale scale-4x">
        <i class="lf"></i>
        <i class="rf"></i>
        <span>4X</span>
        </div>
        <span class="probar scale2x"></span>
        </div>
        <ul class="pull-right">
        ...
        <ul class="timePoint scale2x no-select">
        </ul>
        ...
        <div class="zero-time-line scale2x">
        <div></div>
        <div></div>
        <div></div>
        </div>
        ...
        <ul class="infos_details fl scale2x" id="infos_details"></ul>
        ...
        <shiro:hasPermission name="XGTZYY">
            <li class="noborder" data-url="adjust" style="margin-bottom: 5px"><div>修改调整原因</div></li>
        </shiro:hasPermission>
        ...
        <shiro:hasPermission name="XGPF">
            <li class="" data-url="" style="margin-bottom: 5px"><div>修改批复情况</div></li>
        </shiro:hasPermission>
        </ul>
        ...
        {{ } }}
        {{ } }}
        <li class="v_line" style="display:none;"></li>
        </script>
